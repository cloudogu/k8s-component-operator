...
func (_m *MockManager) GetEventRecorder(name string) recorder.EventRecorder {
	ret := _m.Called(name)
...
func (_c *MockManager_GetEventRecorder_Call) Return(_a0 recorder.EventRecorder) *MockManager_GetEventRecorder_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_GetEventRecorder_Call) RunAndReturn(run func(string) recorder.EventRecorder) *MockManager_GetEventRecorder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockManager) GetFieldIndexer() cacheapi.FieldIndexer {
	ret := _m.Called()
...
func (_c *MockManager_GetFieldIndexer_Call) Return(_a0 cacheapi.FieldIndexer) *MockManager_GetFieldIndexer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_GetFieldIndexer_Call) RunAndReturn(run func() cacheapi.FieldIndexer) *MockManager_GetFieldIndexer_Call {
	_c.Call.Return(run)
	return _c
}
