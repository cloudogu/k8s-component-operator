...
type mockConstructorTestingTnewMockComponentV1Alpha1Client interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockComponentV1Alpha1Client(t mockConstructorTestingTnewMockComponentV1Alpha1Client) *mockComponentV1Alpha1Client {
