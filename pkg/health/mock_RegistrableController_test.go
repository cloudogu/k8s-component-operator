...
type mockConstructorTestingTNewMockRegistrableController interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRegistrableController(t mockConstructorTestingTNewMockRegistrableController) *MockRegistrableController {
