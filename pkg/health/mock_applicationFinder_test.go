...
type mockConstructorTestingTnewMockApplicationFinder interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockApplicationFinder(t mockConstructorTestingTnewMockApplicationFinder) *mockApplicationFinder {
