...
type mockConstructorTestingTnewMockDaemonSetClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDaemonSetClient(t mockConstructorTestingTnewMockDaemonSetClient) *mockDaemonSetClient {
