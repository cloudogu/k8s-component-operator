...
func (_m *mockControllerManager) GetEventRecorder(name string) recorder.EventRecorder {
	ret := _m.Called(name)
	...
	if rf, ok := ret.Get(0).(func(string) recorder.EventRecorder); ok {
		r0 = rf(name)
	} else {
		if ret.Get(0) != nil {
...
func (_c *mockControllerManager_GetEventRecorder_Call) Return(_a0 recorder.EventRecorder) *mockControllerManager_GetEventRecorder_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockControllerManager_GetEventRecorder_Call) RunAndReturn(run func(string) recorder.EventRecorder) *mockControllerManager_GetEventRecorder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *mockControllerManager) GetFieldIndexer() cacheapi.FieldIndexer {
	ret := _m.Called()
	...
	var r0 cacheapi.FieldIndexer
	if rf, ok := ret.Get(0).(func() cacheapi.FieldIndexer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(cacheapi.FieldIndexer)
		}
	}
...
func (_c *mockControllerManager_GetFieldIndexer_Call) Return(_a0 cacheapi.FieldIndexer) *mockControllerManager_GetFieldIndexer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockControllerManager_GetFieldIndexer_Call) RunAndReturn(run func() cacheapi.FieldIndexer) *mockControllerManager_GetFieldIndexer_Call {
	_c.Call.Return(run)
	return _c
}
