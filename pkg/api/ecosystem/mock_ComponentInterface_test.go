...
type mockConstructorTestingTNewMockComponentInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockComponentInterface(t mockConstructorTestingTNewMockComponentInterface) *MockComponentInterface {
