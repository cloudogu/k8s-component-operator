...
func (r *ComponentReconciler) isValuesChanged(ctx context.Context, deployedRelease *release.Release, component *k8sv1.Component) (bool, error) {
	...
	chartSpec.MappedValuesYaml, err = r.getMappedValuesYaml(ctx, component)
	if err != nil {
		return false, err
	}
...
func (r *ComponentReconciler) getMappedValuesYaml(ctx context.Context, component *k8sv1.Component) (string, error) {
	logger := log.FromContext(ctx)
