...
func NewComponentManager(clientset componentInterface, helmClient componentHelmClient, healthManager healthManager, recorder record.EventRecorder) *DefaultComponentManager {
