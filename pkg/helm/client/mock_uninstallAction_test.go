...
type mockConstructorTestingTnewMockUninstallAction interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockUninstallAction(t mockConstructorTestingTnewMockUninstallAction) *mockUninstallAction {
