...
type mockConstructorTestingTnewMockGetReleaseAction interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockGetReleaseAction(t mockConstructorTestingTnewMockGetReleaseAction) *mockGetReleaseAction {
