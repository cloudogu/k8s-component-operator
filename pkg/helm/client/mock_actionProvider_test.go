...
type mockConstructorTestingTnewMockActionProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockActionProvider(t mockConstructorTestingTnewMockActionProvider) *mockActionProvider {
