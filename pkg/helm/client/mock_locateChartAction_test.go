...
type mockConstructorTestingTnewMockLocateChartAction interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockLocateChartAction(t mockConstructorTestingTnewMockLocateChartAction) *mockLocateChartAction {
