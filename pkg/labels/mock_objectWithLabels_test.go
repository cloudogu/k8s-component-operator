...
type mockConstructorTestingTnewMockObjectWithLabels interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockObjectWithLabels(t mockConstructorTestingTnewMockObjectWithLabels) *mockObjectWithLabels {
