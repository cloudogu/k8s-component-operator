...
type mockConstructorTestingTnewMockUnstructuredConverter interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockUnstructuredConverter(t mockConstructorTestingTnewMockUnstructuredConverter) *mockUnstructuredConverter {
